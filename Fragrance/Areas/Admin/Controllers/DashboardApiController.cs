...
namespace Fragrance.Controllers.Api
{
    ...
    public class DashboardApiController : ControllerBase
    {
        ...
        {
            var products = (await _unitOfWork.OrderDetail.GetAllAsync(includeProperties: "Parfume"))
        ...
        {
            Expression<Func<OrderHeader, bool>> sales2025Filter = o => o.OrderDate.Year == 2025;
